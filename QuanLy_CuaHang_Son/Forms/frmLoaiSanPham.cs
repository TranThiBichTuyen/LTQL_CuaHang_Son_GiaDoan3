...
namespace QuanLy_CuaHang_Son.Forms
{
    public partial class frmLoaiSanPham : Form
    {
        ...
        int id;                                 //lấy mã loại sp dùng cho sửa, xóa
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    //xử lý thêm
                    bool daTonTai = context.LoaiSanPham
                    .Any(x => x.TenLoai == txtTenLoai.Text);
                    if (daTonTai)
                    {
                        MessageBox.Show("Sản phẩm này đã tồn tại! Không thể thêm", "Chú ý", MessageBoxButtons.OK, MessageBoxIcon.Error);
